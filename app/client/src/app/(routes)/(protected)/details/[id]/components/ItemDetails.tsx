...
import { Download, Share, LinkIcon } from "lucide-react";
...
export function ItemDetails({ item, id }: ItemDetailsProps) {
    ...
    try {
      ...
      if (navigator.canShare?.({ files })) {
        await navigator.share({
          ...
          text: "Some cool images I wanted to share",
        });
      }
    } catch (error) {
